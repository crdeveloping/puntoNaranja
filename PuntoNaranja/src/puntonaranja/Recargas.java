...
public class Recargas extends javax.swing.JFrame {
    ...
    public Recargas() {
        ...
        tuyoIcon = new ImageIcon("src/resurces/90-141-thickbox.jpg");
        kolbiIcon = new ImageIcon("src/resurces/kolbi.jpg");
        fullIcon = new ImageIcon("src/resurces/fullemovil.png");
