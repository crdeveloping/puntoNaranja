 ...
 void cambioOperadora(String operadora){
    ...
    private void jButton5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton5MouseClicked
        ...
        try {
            ...
            while(cual>=0){
                if(Static.isWindows()) br = new BufferedReader(new FileReader(System.getProperty("user.home")+"\\Puntos Naranja\\Files\\Bitacora\\"+lista[cual]));            
                else br = new BufferedReader(new FileReader(System.getProperty("user.home")+"/Puntos Naranja/Files/Bitacora/"+lista[cual]));    
                String line;
                int cuenta=0;
                String tipo="";
                try {
